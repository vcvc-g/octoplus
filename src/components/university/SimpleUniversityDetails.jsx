// src/components/university/SimpleUniversityDetails.jsx - All sections visible at once
...
const SimpleUniversityDetails = ({ university, onClose, showFull = false }) => {
  ...
  return (
    <div className="p-4 h-full flex flex-col overflow-y-auto">
      {/* All content sections displayed continuously */}
      ...
      <div className="sticky bottom-0 bg-gray-800 -mx-4 px-4 py-3 border-t border-gray-700 mt-8">
